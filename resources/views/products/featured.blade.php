...
@section('title', 'Featured Products - ' . config('app.name'))
@section('description', 'Discover our featured products with the best deals and quality')
    ...
    <div class="page-header pt-3">
        <div class="d-flex align-items-center">
            ...
            <div class="page-title ms-3">
                ...
                <p class="mb-0">Discover our best products</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="view-toggle">
                    <a href="{{ route('products.featured') }}" class="btn btn-sm btn-primary">
                        <i class="ti ti-grid-dots me-1"></i>Grid
                    </a>
                    <a href="{{ route('products.featured') }}?view=list" class="btn btn-sm btn-outline-primary ms-2">
                        <i class="ti ti-list me-1"></i>List
                    </a>
                </div>
                <div class="products-count">
                    <span class="badge bg-primary">{{ $featuredProducts->total() }} Products</span>
                </div>
            </div>
            ...
            @else
                ...
                <div class="empty-products text-center py-5">
                    <div class="mb-4">
                        <i class="ti ti-star" style="font-size: 4rem; color: #ddd;"></i>
                    </div>
                    <h4 class="text-muted mb-3">No Featured Products Found</h4>
                    <p class="text-muted mb-4">We're working on adding more featured products soon!</p>
