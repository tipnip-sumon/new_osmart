            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.general') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.media') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.seo') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.content') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.theme') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.social-media') }}" 
                ...
                <div class="row">
                    <!-- Secondary Settings -->
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.mail-config') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.sms-config') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.general-settings.security') }}" 
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <a href="{{ route('admin.settings.integrations') }}" 
                           class="btn {{ $current === 'integrations' ? 'btn-secondary' : 'btn-outline-secondary' }} w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="row mt-3 pt-3 border-top">
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 mb-2">
                        <a href="{{ route('admin.general-settings.export') }}" class="btn btn-info btn-sm w-100">
...
<div class="modal fade" id="testEmailModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.general-settings.test-email') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
