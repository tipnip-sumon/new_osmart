...
<body>
    ...
    <div class="download-info">
        <h3>Invoice Download Information</h3>
        <p><strong>Downloaded:</strong> {{ now()->format('M d, Y H:i:s') }}</p>
        <p><strong>File:</strong> invoice-{{ $order->order_number }}.html</p>
        <p><strong>Instructions:</strong> You can print this file or save it as PDF using your browser's print function (Ctrl+P → Save as PDF)</p>
    </div>
