                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                                       id="icon" name="icon" value="{{ old('icon') }}" placeholder="bx bx-home">
                                            ...
                                            <div class="input-group">
                                                <select class="form-select @error('route') is-invalid @enderror" id="route" name="route">
                                                    ...
                                                    @foreach($routes as $route)
                                                        <option value="{{ $route['name'] }}" {{ old('route') == $route['name'] ? 'selected' : '' }}>
                                                            {{ $route['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('menu_type') is-invalid @enderror" id="menu_type" name="menu_type" required>
                                                <option value="both" {{ old('menu_type', 'both') == 'both' ? 'selected' : '' }}>Both</option>
                                                <option value="main" {{ old('menu_type') == 'main' ? 'selected' : '' }}>Main Menu</option>
                                                <option value="sidebar" {{ old('menu_type') == 'sidebar' ? 'selected' : '' }}>Sidebar Only</option>
                                            </select>
                                            @error('menu_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('badge_color') is-invalid @enderror" id="badge_color" name="badge_color">
                                                <option value="primary" {{ old('badge_color', 'primary') == 'primary' ? 'selected' : '' }}>Primary</option>
                                                ...
                                                <option value="light" {{ old('badge_color') == 'light' ? 'selected' : '' }}>Light</option>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save"></i> Create Menu
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div id="menuPreview" class="menu-preview">
                                <div class="menu-item-preview">
                                    <i id="previewIcon" class="bx bx-home me-2"></i>
                                    <span id="previewTitle">Menu Title</span>
                                    <span id="previewBadge" class="badge bg-primary ms-2" style="display: none;">Badge</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <ul class="small text-muted">
                                    <li>Use route names when possible for better maintainability</li>
                                    <li>Sort order determines menu position (lower = higher)</li>
                                    <li>External links open in target window</li>
                                    <li>Permissions are checked before displaying menu</li>
                                </ul>
                            </div>
                        </div>
                    </div>
