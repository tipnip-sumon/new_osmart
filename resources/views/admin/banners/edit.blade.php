...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Edit Banner</h1>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                            ...
                                            <option value="informational" {{ old('type', $banner->type) == 'informational' ? 'selected' : '' }}>Informational</option>
                                            <option value="seasonal" {{ old('type', $banner->type) == 'seasonal' ? 'selected' : '' }}>Seasonal</option>
                                            <option value="product_showcase" {{ old('type', $banner->type) == 'product_showcase' ? 'selected' : '' }}>Product Showcase</option>
                                            <option value="newsletter" {{ old('type', $banner->type) == 'newsletter' ? 'selected' : '' }}>Newsletter</option>
                                            <option value="social_media" {{ old('type', $banner->type) == 'social_media' ? 'selected' : '' }}>Social Media</option>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('position') is-invalid @enderror" id="position" name="position" required>
                                            ...
                                            <option value="hero" {{ old('position', $banner->position) == 'hero' ? 'selected' : '' }}>Hero Section</option>
                                            ...
                                            <option value="category_top" {{ old('position', $banner->position) == 'category_top' ? 'selected' : '' }}>Category Top</option>
                                            <option value="category_bottom" {{ old('position', $banner->position) == 'category_bottom' ? 'selected' : '' }}>Category Bottom</option>
                                            <option value="product_detail" {{ old('position', $banner->position) == 'product_detail' ? 'selected' : '' }}>Product Detail</option>
                                            <option value="checkout" {{ old('position', $banner->position) == 'checkout' ? 'selected' : '' }}>Checkout</option>
                                            <option value="floating" {{ old('position', $banner->position) == 'floating' ? 'selected' : '' }}>Floating</option>
                                        </select>
                                        @error('position')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Recommended size: 1200x400px. Leave empty to keep current image.</small>
                                        @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        @if($banner->image_url)
                                            <div class="mt-2">
                                                <img src="{{ $banner->image_url }}" alt="Current Banner" class="img-thumbnail" style="max-width: 200px;">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Recommended size: 600x300px. Leave empty to keep current image.</small>
                                        @error('mobile_image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        @if($banner->mobile_image_url)
                                            <div class="mt-2">
                                                <img src="{{ $banner->mobile_image_url }}" alt="Current Mobile Banner" class="img-thumbnail" style="max-width: 200px;">
                                                <br><small class="text-muted">Current Mobile Image</small>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('start_date') is-invalid @enderror" 
                                       id="start_date" name="start_date" value="{{ old('start_date', $banner->start_date ? $banner->start_date->format('Y-m-d\TH:i') : '') }}">
                                @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('end_date') is-invalid @enderror" 
                                       id="end_date" name="end_date" value="{{ old('end_date', $banner->end_date ? $banner->end_date->format('Y-m-d\TH:i') : '') }}">
                                @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('admin.banners.show', $banner->id) }}" class="btn btn-outline-info">
                                    <i class="bx bx-show"></i> View Banner
                                </a>
                            </div>
                        </div>
                    </div>
