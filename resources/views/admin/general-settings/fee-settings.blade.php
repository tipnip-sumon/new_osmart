    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.general-settings.fee-settings.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('admin.general-settings.general') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Back to General Settings
                            </a>
                        </div>
                    </div>
                </form>
