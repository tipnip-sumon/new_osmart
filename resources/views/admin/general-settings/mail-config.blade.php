            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.general-settings.general') }}" class="btn btn-outline-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form action="{{ route('admin.general-settings.mail-config.update') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   placeholder="noreply@osmartbd.com" 
                                                   required>
                                            @error('from_address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
