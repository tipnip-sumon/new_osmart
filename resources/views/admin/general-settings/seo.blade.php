...
<div class="row mb-4 my-4">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.general-settings.seo.update') }}" method="POST">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="seo-preview">
                                ...
                                <div class="seo-description text-muted" id="seo-preview-description">
                                    {{ $settings->meta_description ?? 'osmartbd - Multi-level marketing platform' }}
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        previewDescription.textContent = descriptionInput.value || 'osmartbd - Multi-level marketing platform';
    }
