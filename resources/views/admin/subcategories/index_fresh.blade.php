                                    ...
                                    <tr>
                                            ...
                                            <span class="avatar avatar-md">
                                                @if($subcategory->image)
                                                    @php
                                                        ...
                                                        $publicPath = public_path('storage/' . $subcategory->image);
                                                        $storageExists = file_exists(storage_path('app/public/' . $subcategory->image));
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    ...
                                                    <div class="text-muted fs-12">{{ $subcategory->slug }}</div>
                                        ...
                                        <td>
                                            @if($subcategory->category)
                                                <span class="parent-category">{{ $subcategory->category->name }}</span>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $subcategory->status == 'Active' ? 'success' : 'danger' }} status-toggle" 
                                                  data-id="{{ $subcategory->id }}" data-status="{{ $subcategory->status }}">
                                                {{ ucfirst($subcategory->status) }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-{{ $subcategory->is_featured ? 'warning' : 'secondary' }} featured-toggle" 
                                                  data-id="{{ $subcategory->id }}" data-featured="{{ $subcategory->is_featured ? 'true' : 'false' }}">
                                        ...
                                        <td>
                                            <span class="text-muted">{{ $subcategory->created_at ? $subcategory->created_at->format('M d, Y') : 'N/A' }}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-1 table-actions">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item text-warning" href="#" onclick="toggleFeatured({{ $subcategory->id }}, {{ $subcategory->is_featured ? 'false' : 'true' }})">
                                                            <i class="ri-star-line me-2"></i>{{ $subcategory->is_featured ? 'Remove from Featured' : 'Mark as Featured' }}</a></li>
                                                        <li><a class="dropdown-item text-info" href="#" onclick="toggleStatus({{ $subcategory->id }}, '{{ $subcategory->status == 'Active' ? 'Inactive' : 'Active' }}')">
                                                            <i class="ri-toggle-line me-2"></i>{{ $subcategory->status == 'Active' ? 'Deactivate' : 'Activate' }}</a></li>
                                                        <li><hr class="dropdown-divider"></li>
...
function toggleStatus(id, status) {
    Swal.fire({
        title: 'Change Status',
        text: `Are you sure you want to ${status.toLowerCase()} this subcategory?`,
        icon: 'question',
...
function toggleFeatured(id, featured) {
    ...
    Swal.fire({
        ...
        text: `Are you sure you want to ${action} this subcategory?`,
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire('Success!', `Subcategory ${action}d successfully.`, 'success');
                    window.location.reload();
                } else {
