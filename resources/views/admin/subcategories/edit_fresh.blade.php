                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                            ...
                                            <option value="1" {{ old('category_id', $subcategory['category_id'] ?? '1') == '1' ? 'selected' : '' }}>Electronics</option>
                                            <option value="2" {{ old('category_id', $subcategory['category_id'] ?? '') == '2' ? 'selected' : '' }}>Fashion</option>
                                            <option value="3" {{ old('category_id', $subcategory['category_id'] ?? '') == '3' ? 'selected' : '' }}>Home & Garden</option>
                                            <option value="4" {{ old('category_id', $subcategory['category_id'] ?? '') == '4' ? 'selected' : '' }}>Sports & Fitness</option>
                                            <option value="5" {{ old('category_id', $subcategory['category_id'] ?? '') == '5' ? 'selected' : '' }}>Beauty & Health</option>
                                        </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="text-center">
                                    <img src="{{ $subcategory['image'] }}" alt="Current Image" 
