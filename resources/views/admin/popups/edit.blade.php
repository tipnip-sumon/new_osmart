    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                ...
                Edit Popup: <span class="text-primary">{{ $popup->name }}</span>
            </h1>
            <p class="text-secondary mb-0 mt-2">
                <i class="fas fa-pencil-alt me-2"></i>
                Modify popup settings and content
            </p>
        </div>
        <div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        @if($popup->image || $popup->image_data)
                            <div class="mb-4">
                                <label class="form-label text-secondary fw-semibold mb-3">Current Images:</label>
                                ...
                                @if(count($allSizes) > 0)
                                    ...
                                    <div class="mb-3">
                                        <button type="button" class="btn btn-outline-danger" onclick="removeCurrentImage()">
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label text-secondary fw-semibold">
                                @if($popup->image || $popup->image_data)
                                    <i class="fas fa-sync-alt me-2"></i>Replace Image
                                @else
                        ...
                        <div id="imagePreview" class="mt-3" style="display: none;">
                            <label class="form-label text-secondary fw-semibold">New Image Preview:</label>
                            <div class="border rounded-3 p-3 bg-light text-center" style="max-width: 300px;">
                                <img id="previewImage" src="#" alt="New Image Preview" class="img-fluid rounded shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="guests" id="user_guests" name="target_users[]"
                                       {{ in_array('guests', $targetUsers) || in_array('new', $targetUsers) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="registered" id="user_registered" name="target_users[]"
                                       {{ in_array('registered', $targetUsers) || in_array('logged_in', $targetUsers) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="new_visitors" id="user_new_visitors" name="target_users[]"
                                       {{ in_array('new_visitors', $targetUsers) || in_array('new', $targetUsers) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="returning_visitors" id="user_returning_visitors" name="target_users[]"
                                       {{ in_array('returning_visitors', $targetUsers) || in_array('returning', $targetUsers) ? 'checked' : '' }}>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center p-0">
                        <img src="${imageUrl}" alt="Image preview" class="img-fluid" style="max-width: 100%; height: auto;">
                    </div>
                    <div class="modal-footer">
