...
@section('title', 'Edit Banner Collection')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Banner Collection</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Banner Collection: {{ $bannerCollection->title }}</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.banner-collections.update', $bannerCollection) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   id="title" name="title" value="{{ old('title', $bannerCollection->title) }}" required>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" required>{{ old('description', $bannerCollection->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('button_text') is-invalid @enderror" 
                                           id="button_text" name="button_text" value="{{ old('button_text', $bannerCollection->button_text) }}" required>
                                    @error('button_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('button_url') is-invalid @enderror" 
                                           id="button_url" name="button_url" value="{{ old('button_url', $bannerCollection->button_url) }}" 
                            ...
                            <div class="card-header">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" 
                                           ...
                                           {{ old('show_countdown', $bannerCollection->show_countdown) ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="show_countdown">
                                        <strong>Show Countdown Timer</strong>
                                    </label>
                                </div>
                            </div>
                            <div class="card-body" id="countdown-settings" style="display: {{ old('show_countdown', $bannerCollection->show_countdown) ? 'block' : 'none' }};">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control @error('countdown_end_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('countdown_end_date', $bannerCollection->countdown_end_date ? $bannerCollection->countdown_end_date->format('Y-m-d\TH:i') : '') }}" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="color" class="form-control color-input @error('background_color') is-invalid @enderror" 
                                                       id="background_color" name="background_color" value="{{ old('background_color', $bannerCollection->background_color) }}">
                                                <div class="input-group-append">
                                                    <input type="text" class="form-control" id="bg_color_text" value="{{ old('background_color', $bannerCollection->background_color) }}" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="color" class="form-control color-input @error('text_color') is-invalid @enderror" 
                                                       id="text_color" name="text_color" value="{{ old('text_color', $bannerCollection->text_color) }}">
                                                <div class="input-group-append">
                                                    <input type="text" class="form-control" id="text_color_text" value="{{ old('text_color', $bannerCollection->text_color) }}" readonly>
                                                </div>
                                            </div>
                                            @error('text_color')
                                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-lg-4">
                        <!-- Current Images -->
                        @if($bannerCollection->image || $bannerCollection->images_data)
                        <div class="form-section">
                            <div class="form-section-header">
                                <h4 class="form-section-title">
                                    <i class="ti ti-photo text-success me-2"></i>
                                    Current Images
                                </h4>
                                <small class="text-muted">Existing banner images</small>
                            </div>
                            <div class="current-images-grid">
                                @if($bannerCollection->image)
                                    <div class="preview-item">
                                        <img src="{{ $bannerCollection->best_image_url }}" alt="Current Image">
                                        <div class="badge badge-primary position-absolute" style="top: 5px; left: 5px; font-size: 10px;">Main</div>
                                    </div>
                                @endif
                                
                                @if($bannerCollection->thumbnail_urls)
                                    @foreach($bannerCollection->thumbnail_urls as $index => $thumbnail)
                                        @if($index > 0) {{-- Skip first if it's the same as main image --}}
                                        <div class="preview-item">
                                            <img src="{{ $thumbnail }}" alt="Image {{ $index }}">
                                        </div>
                                        @endif
                                    @endforeach
                                @endif
                        ...
                        <div class="form-section">
                            <div class="form-section-header">
                                <h4 class="form-section-title">
                                    ...
                                    {{ $bannerCollection->image ? 'Update Images' : 'Banner Images' }}
                                </h4>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $bannerCollection->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" 
                                           ...
                                           {{ old('is_active', $bannerCollection->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update Banner Collection
                    </button>
