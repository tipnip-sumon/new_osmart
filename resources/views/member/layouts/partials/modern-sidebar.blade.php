        ...
        <div class="sidebar-menu">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item has-submenu {{ request()->routeIs('admin.delivery-charges.*') ? 'active' : '' }}">
                        <a href="#" class="nav-link">
                            <i class='bx bx-truck nav-icon'></i>
                            <span class="nav-text">Delivery Charges</span>
                            <i class='bx bx-chevron-right nav-arrow'></i>
                        </a>
                        <ul class="nav-submenu">
                            <li><a href="{{ route('admin.delivery-charges.index') }}">All Charges</a></li>
                            <li><a href="{{ route('admin.delivery-charges.create') }}">Add New Charge</a></li>
                        </ul>
                    </li>
