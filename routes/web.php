...
Route::get('/api/translations/{locale}', function ($locale) {
    ...
    $translations = [
        ...
        'team_ceo_name' => __('about.team_ceo_name'),
        'team_ceo_position' => __('about.team_ceo_position'),
        'team_ceo_bio' => __('about.team_ceo_bio', ['app_name' => config('app.name')]),
        'team_cto_name' => __('about.team_cto_name'),
        'team_cto_position' => __('about.team_cto_position'),
        'team_cto_bio' => __('about.team_cto_bio'),
        'team_marketing_name' => __('about.team_marketing_name'),
        'team_marketing_position' => __('about.team_marketing_position'),
        'team_marketing_bio' => __('about.team_marketing_bio'),
